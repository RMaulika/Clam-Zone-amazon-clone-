    ...
    <div className='home'>
        <div className="home__container">
            ...
            <div className="home__row">
              ...
              <Product id="49538094" title="Kenwood kMix Satnd Mixer for Baking, Stylish Kitchen Mixer with K-beater, Dough Hook and Whisk, 5 Litre Glass Bowl" price={239.0} rating={4} image="/banner3.jpg"/>
            </div>
            <div className="home__row">
